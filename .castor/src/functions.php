 ...
 * @param array<string> $commands
 */
function php(array $commands = [], string $user = 'www-data'): Docker
{
 ...
 * @param array<string> $commands
 */
function composer(array $commands = [], string $user = 'www-data'): Docker
{
 ...
 * @param array<string> $commands
 */
function console(array $commands = [], string $user = 'www-data'): Docker
{
